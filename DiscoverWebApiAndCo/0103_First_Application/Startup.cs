    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(options =>
            {
                ...
                options.AddPolicy(specificOrigin2, builder =>
                {
                    builder.WithOrigins("http://127.0.0.1:5500").WithMethods("POST");
                });
        ...
        const string specificOrigin2 = "customOrigin2";
