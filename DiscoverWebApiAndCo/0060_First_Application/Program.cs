        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
             .ConfigureAppConfiguration((context, builder) =>
             {
                 ...
                 builder.AddJsonFile($"test.{context.HostingEnvironment.EnvironmentName}.json", false, true);
                 builder.AddJsonFile("oneobject.json", false, true);
                 builder.AddJsonFile($"oneobject.{context.HostingEnvironment.EnvironmentName}.json", true, true);
             })
